...
export default function Home() {
  ...
  <nav className="top-0 left-0 w-full mt-4 z-50 p-4 pb-16">
    <ul className="flex justify-center items-center mx-w-7xl gap-8 mr-8 text-sm font-medium">
      ...
      <li className="hover:scale-105 active:scale-95" title="Download CV"><a target="_blank" href="https://docs.google.com/document/d/e/2PACX-1vQRIZ1GFpeamn80hk7kaCp_y8QMEwlKhUWDxJKOCnX6KBvmKBaeCZHAcYJfakq87ZSiSegxe8sucemQ/pub"><Image src={cvIcon} alt="cv download" width={45} height={45}/></a></li>
    </ul>
  </nav>
  <div className="flex flex-col items-center text-sm gap-4 justify-center max-w-4xl mx-auto p-4 space-y-8">
    ...
    <section className="w-full">
      ...
      <ul className="flex justify-center mx-w-7xl gap-8 mr-8 text-sm font-medium">
        ...
        <li className="hover:scale-105 active:scale-95" title="Download CV"><a target="_blank" href="https://docs.google.com/document/d/e/2PACX-1vQRIZ1GFpeamn80hk7kaCp_y8QMEwlKhUWDxJKOCnX6KBvmKBaeCZHAcYJfakq87ZSiSegxe8sucemQ/pub"><Image src={cvIcon} alt="cv download" width={50} height={50}/></a></li>
      </ul>
      </div>
    </section>
  </div>
